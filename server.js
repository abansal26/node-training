...
http.createServer(function (req, res) {
    ...
    res.write("The second largest number in " + input_array + " is : "+ secondLargest(input_array) + '</br>');
    res.write("The frequency of characters in " + util.inspect(input_string) + " is : "+ util.inspect(calculateFrequency(input_string)) + '</br>');
    res.write("The flattening of " + util.inspect(unflatObject) + " is : "+ util.inspect(flatten(unflatObject)) + '</br>');
    res.write("The unflattening of " + util.inspect(flatObject) + " is : "+ util.inspect(unflatten(flatObject)) + '</br>');
    res.end();
}).listen(8080); 